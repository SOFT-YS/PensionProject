...
public class ScrewMain {
    private static final String DB_URL = "jdbc:mysql://81.68.246.75:3306";
    private static final String DB_NAME = "pension_program?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=UTC";
    private static final String DB_USERNAME = "pension_program";
    private static final String DB_PASSWORD = "TYHFb68KCf3YtELi";
    ...
    private static final String DOC_FILE_NAME = "养老系统设计";
    private static final String DOC_VERSION = "版本号";
    private static final String DOC_DESCRIPTION = "养老";
    ...
    private static ProcessConfig buildProcessConfig() {
        return ProcessConfig.builder()
                ...
                // 忽略表前缀
                .ignoreTablePrefix(Collections.singletonList("_"))
                // 忽略表后缀
